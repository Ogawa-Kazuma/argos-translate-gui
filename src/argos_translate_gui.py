...
"""
Argos Translate GUI
A modern graphical user interface for Argos Translate
"""
...
try:
    ...
    print(f"Error importing Argos Translate: {e}")
...
class ArgosTranslateGUI:
    ...
    def create_settings_tab(self):
        ...
        self.debug_var = tk.BooleanVar(value=settings.debug)
        ...
        self.pkg_dir_var = tk.StringVar(value=str(settings.package_data_dir))
